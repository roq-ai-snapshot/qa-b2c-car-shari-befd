    ...
    >
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          <NumberInput
            label="Billing Invvoice"
            formControlProps={{
              id: 'billing_invvoice',
              isInvalid: !!formik.errors?.billing_invvoice,
            }}
            name="billing_invvoice"
            error={formik.errors?.billing_invvoice}
            value={formik.values?.billing_invvoice}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('billing_invvoice', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
